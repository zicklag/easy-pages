	...
	<div>
		<div class="alert shadow-lg">
			<div>
				...
				>
				{#if data.repoExists}
					<span>Repository exists: it's GitHub Pages configuration will be updated.</span>
				{:else}
					<span>Repository does not exist: it will be created.</span>
				{/if}
			</div>
		</div>
	</div>
...
<div class="flex flex-col items-center mt-8">
	...
	>
		...
		<div class="flex items-center mt-4">
			<a href="/publish/github" class="btn"> Back </a>
			...
			{#if loading}
				<Spinner />
			{/if}
			<button type="submit" class="btn btn-primary flex gap-2 items-center" disabled={loading}>
				Deploy
				<svg
					xmlns="http://www.w3.org/2000/svg"
					width="16"
